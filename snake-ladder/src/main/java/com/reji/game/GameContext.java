...
public class GameContext implements Runnable{
    ...
    public void run() {
        ...
        while(!isGameOver) {
            ...
            // game logic here
            // loop through each player and call play() method after rolling dice using Dice.roll()
                    // On every move, evaluate if a pos manipulator (snake or ladder) is registered with the cell.
